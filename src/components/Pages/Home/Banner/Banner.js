                ...
                <Carousel variant="ligth">
                    <Carousel.Item className="carousel-one">
                        <Container className="px-md-5">
                            <Row>
                                <Col sm={12} lg={6}>
                                    <div className="animate__animated animate__fadeInLeft text-start">
                                        <h5 className="banner-sub-title">Welcome to</h5>
                                        <h1 className="banner-title mb-2">Fast Delivery Services</h1>
                                        <p className="mb-4 banner-text">
                                            We provide professional delivery services at Fast Delivery.
                                            We make sure that your product is delivered on time.
                                        </p>
                                        <Link to="/services">
                                            <Button className="delivery-btn px-4 py-2" variant="">
                                                Services
                                            </Button>
                                        </Link>
                                    </div>
